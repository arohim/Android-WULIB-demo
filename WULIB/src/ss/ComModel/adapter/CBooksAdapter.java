...
public class CBooksAdapter extends BaseAdapter {
	...
	public CBooksAdapter(Activity context, ArrayList<Books> results) {
		try {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			if (convertView == null) {
				convertView = l_Inflater.inflate(R.layout.lv_it_cbooks, null);
				holder = new ViewHolder();
				...
				holder.booksDate = (TextView) convertView
						.findViewById(R.id.lv_it_rs_booksdate);
			...
			holder.booksDate.setText(component.getDate(book.getBooksDate()
					.split(" ")[0]));
