...
public class JMainHistory extends Activity {

	public static ArrayList<JournalsHistory> journalHistory = null;
	...
	private void bindLVItem() throws Exception {
		// try {
		ListView lv = (ListView) findViewById(R.id.history_lv);
		lv.setAdapter(new JHistoryAdapter(this, journalHistory));
	...
	private void goToDetail() {
		Intent in = new Intent(JMainHistory.this, JHistoryFragmentActivity.class);
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		try {
			super.onCreateContextMenu(menu, v, menuInfo);
			menu.setHeaderTitle(journalHistory.get(positionSelected).getTitle());
