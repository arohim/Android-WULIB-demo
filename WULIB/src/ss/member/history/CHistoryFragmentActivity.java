...
import ss.ComModel.adapter.CHistoryFragmentAdapter;
...
public class CHistoryFragmentActivity extends FragmentActivity {
	@Override
	protected void onCreate(Bundle arg0) {
		...
		try {
			...
			CHistoryFragmentAdapter pagerAdapter = new CHistoryFragmentAdapter(
					this, fm);
