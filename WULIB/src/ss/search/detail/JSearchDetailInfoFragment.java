...
public class JSearchDetailInfoFragment extends Fragment {

	// public static int bookDetailCurrentPage = 0;
	int position = 0;
	private Activity context;

	public JSearchDetailInfoFragment(Activity context) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.jsearch_detail_info, container,
				false);
		bindData(v);
		return v;
	}
