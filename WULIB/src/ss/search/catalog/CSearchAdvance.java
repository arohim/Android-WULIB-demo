...
@SuppressLint("NewApi")
public class CSearchAdvance extends Activity {
...
//			}
	...
	public void searchAdvance() {
		...
		if (!((sf1.getText().toString()).isEmpty())) {
			...
			in.putExtra("className", CSearchAdvance.class + "");
...
//			startActivity(in);
	...
	private class LoadActivityThread extends AsyncTask<Intent, Void, Void> {
		...
		private ProgressDialog dialog = new ProgressDialog(CSearchAdvance.this);
